        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="pull-right">
                    <a href="#" role="button" class="btn btn-sm btn-primary">등록하기</a>
                </div>
            ...
            <div class="card-body">
                <form class="" role="form" action="">
                    <div class="form-row">
                        <label for="inlineRadio1" class="col-sm-1 col-form-label">검색1</label>
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="inlineRadio2">조건1</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="radio" name="inlineRadioOptions" id="inlineRadio3" value="option3">
                            <label class="form-check-label" for="inlineRadio3">조건2</label>
                        </div>
                    </div>
                    <div class="form-row">
                        <label for="inlineCheckbox1" class="col-sm-1 col-form-label">검색2</label>
                        <div class="form-check form-check-inline">
                        ...
                        <div class="form-check form-check-inline">
                            ...
                            <label class="form-check-label" for="inlineCheckbox2">조건1</label>
                        </div>
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="option3">
                            <label class="form-check-label" for="inlineCheckbox3">조건2</label>
                        </div>
                    </div>
                    <div class="form-row">
                        <label for="inputSelect" class="col-sm-1 col-form-label">검색3</label>
                    ...
                    <div class="form-row">
                        <label for="dateRangeKind" class="col-sm-1 col-form-label">기간</label>
                        <div class="form-group col-sm-1">
                            <select class="form-control" name="" id="dateRangeKind">
