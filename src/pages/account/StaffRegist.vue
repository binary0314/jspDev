                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-sm-4">
                                    <input type="text" class="form-control" value="" placeholder="- 포함">
                                </div>
                            </div>
                            <div class="form-row">
                                <label class="col-sm-1 col-form-label">내선번호</label>
                                <div class="form-group col-sm-4">
                                    <input type="text" class="form-control" value="" placeholder="4자리">
                                </div>
                        ...
                        <li class="list-group-item">
                            <div class="form-row">
                                <div class="col-sm-12 text-center">
                                    ...
                                    <g-link href="staff" role="button" class="btn btn-outline-secondary btn-lg"><i class="fa fa-list"></i> 목록</g-link>
                                </div>
                            </div>
                        </li>
                    </ul>
